...
local colors = {
	...
	blue = "wool:blue",
	cyan = "wool:cyan",
	green = "wool:dark_green",
	lightgreen = "wool:green",
	pink = "wool:pink",
	purple = "wool:violet",
	red = "wool:red",
	yellow = "wool:yellow ",
...
local descrs = {
	...
	leather = S("Leather Bag of Stuff"),
...
for color, material in pairs(colors) do
	...
	local hsl = string.format("^[hsl:%d:%d:%d", hsl[color]["h"], hsl[color]["s"],
	                          hsl[color]["l"])
	local inventory_image = "prestibags_bag_inv.png" .. hsl
	local wield_image = "prestibags_bag_inv.png" .. hsl
	local textures = {"prestibags_bag.png" .. hsl}
	...
	core.register_craft({
		...
		recipe = {{"", material, ""}, {material, "", material}, {material, material, material}},
	})
end
